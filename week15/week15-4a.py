# week15-4a.py
# LeetCode 75: DP - Multidimensional Q4 72. Edit Distance
# 編輯(插入1字母、刪除1字母、換掉1字母)幾次後，會得到 word2
class Solution:
    def minDistance(self, word1: str, word2: str) -> int:
        ...
        def helper(i, j):  # 現在要處理 word1[i] vs. word2[j]
            ...
            # ans1 = helper(i+1, j)    # 跳掉 word1[i] (刪除)
            # ans2 = helper(i, j+1)    # 跳掉 word2[j] (插入)
            # ans3 = helper(i+1, j+1)  # 將 word1[i] 換成 word2[j] (替換)
